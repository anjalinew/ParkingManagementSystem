...
/**
 * @author Krunal C0849574,Kavan C0843282,Harsh C0850579,Manthan C0853905 ,Anjali C0853334,Ruby C085336 
 * Create a parking management system with different functionality
 * 
 */
			...
			if (menuChoice == 1) {
				...
				if (dataList.size() == numSpaces) {
					...
					if (monthly_pass.equals("yes")) {
						...
						// check barcode and cross verify cross verify with license plate Number
